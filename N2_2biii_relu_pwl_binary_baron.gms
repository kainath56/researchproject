...
*Dataset        :   Binary
*ML Classifier  :   ANN relu & sigmoid : 2biii
*Solver         :   Baron
*Threads        :   1
*Time limit     :   3600s
*==============================================================================
...
eq_relu1(hl1)..           h0(hl1)+h1(hl1)+h2(hl1)+h3(hl1)=e=1;
eq_relu2(hl1)..           a1(hl1)+a2(hl1)+a3(hl1)=e=1;

eq_relu3(hl1)..           a1(hl1)=l=h0(hl1)+h1(hl1);
eq_relu4(hl1)..           a2(hl1)=l=h1(hl1)+h2(hl1);
eq_relu5(hl1)..           a3(hl1)=l=h2(hl1)+h3(hl1);

eq_relu6(hl1)..           inter1v(hl1) =e= a1(hl1)*xval1('1')    +   a2(hl1)*xval1('2')     +   a3(hl1)*xval1('3')   ;
eq_relu7(hl1)..           inter1z(hl1) =e= a1(hl1)*yval1('1')     +  a2(hl1)*yval1('2')     +   a3(hl1)*yval1('3')  ;
...
inter1z.l(hl1) = a1.l(hl1)*yval1('1')    +   a2.l(hl1)*yval1('2')     +   a3.l(hl1)*yval1('3') ;
