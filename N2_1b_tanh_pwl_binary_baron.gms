...
*Dataset        :   Binary
*ML Classifier  :   ANN tanh & sigmoid: 1b
*Solver         :   Baron
*Threads        :   1
*Time limit     :   3600s
*===========================================================================================================================================================
...
*HIDDEN LAYER TANH
eq_tanh1(hl1)..           h0(hl1)+h1(hl1)+h2(hl1)+h3(hl1)+h4(hl1)=e=1;
eq_tanh2(hl1)..           a1(hl1)+a2(hl1)+a3(hl1)+a4(hl1)=e=1;

eq_tanh3(hl1)..           a1(hl1)=l=h0(hl1)+h1(hl1);
eq_tanh4(hl1)..           a2(hl1)=l=h1(hl1)+h2(hl1);
eq_tanh5(hl1)..           a3(hl1)=l=h2(hl1)+h3(hl1);
eq_tanh6(hl1)..           a4(hl1)=l=h3(hl1)+h4(hl1);

eq_tanh7(hl1)..           inter1v(hl1) =e= a1(hl1)*xval1('1')    +   a2(hl1)*xval1('2')     +   a3(hl1)*xval1('3')  +   a4(hl1)*xval1('4') ;
eq_tanh8(hl1)..           inter1z(hl1) =e= a1(hl1)*yval1('1')     +   a2(hl1)*yval1('2')     +   a3(hl1)*yval1('3')  +   a4(hl1)*yval1('4') ;
...
*calculated for the methanol chloroform case
*[-50,-1,1,50]
h0.fx(hl1)=0;
h4.fx(hl1)=0;
h1.l(hl1) =0;
...
inter1z.l(hl1) = a1.l(hl1)*yval1('1')    +   a2.l(hl1)*yval1('2')     +   a3.l(hl1)*yval1('3')  +   a4.l(hl1)*yval1('4') ;
