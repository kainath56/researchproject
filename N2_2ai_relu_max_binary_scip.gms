...
*Dataset        :   Binary
*ML Classifier  :   ANN relu & sigmoid - 2ai
*Solver         :   Baron
*Threads        :   1
*Time limit     :   3600s
*==============================================================================
...
*HIDDEN LAYER RELU
eq_inter1(hl1)..             inter_relu(hl1) =e= max(0, sum(f, wt1(f,hl1)*inp(f)) + bias1(hl1));
...
inter_relu.l(hl1) = max(0,sum(f, wt1(f,hl1)*inp.l(f)) + bias1(hl1));
