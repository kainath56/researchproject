...
*Dataset        :   Binary
*ML Classifier  :   ANN relu & sigmoid : 2aiii
*Solver         :   BARON
*Threads        :   1
*Time limit     :   3600s
*==============================================================================
...
**************BIG-M BOUNDS***************************
LB0(hl1)
/1   -134.99998128414154
2   -131.93605615198612
3   -150.3768016397953
4   -108.49725568294525
5   -34.31772181391716
6   -90.03505283594131
7   -46.01755875349045/

UB0(hl1)
/1  132.34692776203156
2   133.65372659265995
3   150.81218287348747
4   113.3717850446701
5   37.18345305323601
6   88.99162417650223
7   45.29417258501053/
...
inter_relu(hl1)  'output from relu function'
...
*HIDDEN LAYER RELU
eq_inter(hl1)..                     inter_relu(hl1) =g= sum(f, wt1(f,hl1)*inp(f)) + bias1(hl1);
eq_inter1lb(hl1)..                  inter_relu(hl1) =l= ( sum(f, wt1(f,hl1)*inp(f)) + bias1(hl1) )- (1-sigma(hl1))*LB0(hl1);
eq_inter1ub(hl1)..                  inter_relu(hl1) =l= sigma(hl1)*UB0(hl1);

*OUTPUT LAYER SIGMOID
eq_inter2v..                        inter2v =e= sum(hl1, wt2(hl1)*inter_relu(hl1)) + bias2;
...
inter_relu.l(hl1) = sum(f, wt1(f,hl1)*inp.l(f)) + bias1(hl1);
inter2v.l = sum(hl1, wt2(hl1)*inter_relu.l(hl1)) + bias2;
